...
def get_test_loader(setting: str, adaptation: str, dataset_name: str, preprocess: Union[transforms.Compose, None],
                    ...
                    batch_size: int = 128, shuffle: bool = False, workers: int = 4, cfg: dict = None):
    """
    ...
    if domain_name == "none":
        ...
        if dataset_name in ["cifar10_c", "cifar100_c"]:
            ...
            # dset_path = "/home/wei/Documents/Dataset/CCC/dataset/baseline_20.0_transition+speed_2000_seed_43/"
            ...
            domain_name = cfg.CORRUPTION.TYPE[0]
            domain_name = "baseline_40_transition+speed_1000_seed_43"
            ...
            dataloader = torch.utils.data.DataLoader(test_dataset, num_workers=8, batch_size=batch_size, drop_last=True)
            return dataloader
